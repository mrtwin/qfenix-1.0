...
<title>Разработка Сайта под Ваш бюджет | Fenix</title>
<meta name="description" content="Создадим сайт под Ваш бюджет. Скажите сколько Вы готовы потратить на разработку сайта и мы предложим оптимальный вариант."/>

<?php include 'header.php' ?>

<!--=== main ===-->

	<div class="slider" style="background: url(img/budget.jpg);background-size: cover;">
		<div class="slider_text">
			<div class="slider_text_header">Сайт под Ваш бюджет</div>
			<div class="slider_text_description">Гибкий тариф. Все возможно.</div>
			<br>
			<div class="batton">
	...
	<!-- main-content -->
		<div class="main_content">
			<h1>Создание сайта под Ваш бюджет</h1>
